...
from pts_pops_app import views as error_handle_views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', include('pts_pops_app.urls', namespace='pts_pops_app')),
...
# If settings.DEBUG is true then we will use the media url as a src
if settings.DEBUG:
